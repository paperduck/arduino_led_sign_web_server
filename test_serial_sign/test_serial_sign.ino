...
byte   sign_packet_8[22] = {
  0x00 , 0xFF , 0xFF , 0x00 , 0x0B , 0x01 , 0xFF , 0x01 , 0x30 , 0x31 , 0xEF , 0xB0 , 0xEF , 0xA2 , 0x42 , 0x65 , 0x6C , 0x6C , 0x6F , 0xFF , 0xFF , 0x00 };

byte   sign_packet_8_1[8] = { 
  0x00, 0xff, 0xff, 0x00, 0x0b, 0x01, 0xff, 0x01 };
byte   sign_packet_8_2[8] = { 
  0x30, 0x31, 0xef, 0xb0, 0xef, 0xa2, 0x41, 0x41 };
byte   sign_packet_8_3[8] = { 
  0x41, 0x41, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 };


char   sign_packet_8_1_[8] = { 
  0x00, 0xff, 0xff, 0x00, 0x0b, 0x01, 0xff, 0x01 };
char   sign_packet_8_2_[8] = { 
  0x30, 0x31, 0xef, 0xb0, 0xef, 0xa2, 0x41, 0x41 };
char   sign_packet_8_3_[5] = { 
